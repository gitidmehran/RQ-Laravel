...
class PhrasesWords extends Model
{
    use HasFactory;
    protected $fillable = ['word_id','phrase_word_id','scholar_id'];
    ...
    public function phraseWordTranslation()
    {
        return $this->hasOneThrough(PhrasesWordsTranslations::class,Words::class,'id','word_id');
    }
    ...
    public function phraseword(){
        return $this->belongsTo(Words::class,'phrase_word_id','id');
    }
