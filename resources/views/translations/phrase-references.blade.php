<form method="post" action="{{url('dashboard/save-phrase-word-references')}}" class="make_ajax" enctype="multipart/form-data">
                            ...
                            <tr>
                                ...
                                @foreach( $val as $k => $v )
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input related-words" name="reference_phrase_words[]" type="checkbox" value="{{$id}}" id="defaultCheck{{$id}}" @if(in_array($id,$words)) checked @endif>
                                    </div>
                                @endforeach
